#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To sahil jan
...
\033[1;93m▇▇▇▇▇ Facebook\033[1;93m Sahil ▇▇▇▇▇
\033[1;97m
                 ⊂ヽ
               　 ＼＼  Λ＿Λ
              　　 ＼(  ˘ω˘  )
                　　　 >　⌒ヽ
                 ...
                 　 /　/|
                  ...
                  　| |　　) /
                   ノ )    Lﾉ
                  (_／     　　　
\033[1;97m:•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•\033[1;93mtufani tiger\033[1;97m•◄►•═ ═ ═ ═ ═ ═ ═ •◄►•"""
...
\033[1;97m       whatsup numbr 03032069921
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:sahil
	    time.sleep(2)
            loop = 'false'
        else:
